...
-type con_color_24() :: {con_color_8(), con_color_8(), con_color_8()} | <<_:24>>.
-type con_color() :: con_color_4() | con_color_8() | con_color_24().
-type con_cursor_dir() :: up | down | left | right | next | prev | horizontal.
-type con_cursor() ::
    con_cursor_dir() | {con_cursor_dir() | integer()} | {pos, integer(), integer()}.
...
style_code(strike) ->
    "9";
style_code(double_underline) ->
    "21";
style_code(framed) ->
    "51";
style_code(encircled) ->
    "52";
style_code(overlined) ->
    "53";
style_code(ideogram_underline) ->
    "60";
style_code(ideogram_double_underline) ->
    "61";
style_code(ideogram_overline) ->
    "62";
style_code(ideogram_double_overline) ->
    "63";
style_code(ideogram_stress) ->
    "64";
style_code(superscript) ->
    "73";
style_code(subscript) ->
    "74".
...
reset_code(italic) ->
    "23";
reset_code(underline) ->
    "24";
reset_code(blink) ->
    "25";
reset_code(fast_blink) ->
    "25";
reset_code(invert) ->
    "27";
reset_code(hide) ->
...
reset_code(strike) ->
    "29";
reset_code(double_underline) ->
    "24";
reset_code(framed) ->
    "54";
reset_code(encircled) ->
    "54";
reset_code(overlined) ->
    "55";
reset_code(ideogram_underline) ->
    "65";
reset_code(ideogram_double_underline) ->
    "65";
reset_code(ideogram_overline) ->
    "65";
reset_code(ideogram_double_overline) ->
    "65";
reset_code(ideogram_stress) ->
    "65";
reset_code(superscript) ->
    "75";
reset_code(subscript) ->
    "75".
...
color_code({fg, green}) ->
    "32";
color_code({fg, yellow}) ->
    "33";
color_code({fg, blue}) ->
    "34";
color_code({fg, magenta}) ->
    "35";
color_code({fg, cyan}) ->
    "36";
color_code({fg, white}) ->
    "37";
color_code({fg, default}) ->
    "39";
color_code({bg, black}) ->
    "40";
color_code({bg, red}) ->
...
color_code({bg, blue}) ->
    "44";
color_code({bg, magenta}) ->
    "45";
color_code({bg, cyan}) ->
    "46";
color_code({bg, white}) ->
    "47";
color_code({bg, default}) ->
    "49";
color_code({fg, bright_black}) ->
    "90";
color_code({fg, bright_red}) ->
    "91";
color_code({fg, bright_green}) ->
    "92";
color_code({fg, bright_yellow}) ->
    "93";
color_code({fg, bright_blue}) ->
    "94";
color_code({fg, bright_magenta}) ->
    "95";
color_code({fg, bright_cyan}) ->
    "96";
color_code({fg, bright_white}) ->
    "97";
color_code({bg, bright_black}) ->
    "100";
color_code({bg, bright_red}) ->
    "101";
color_code({bg, bright_green}) ->
    "102";
color_code({bg, bright_yellow}) ->
    "103";
color_code({bg, bright_blue}) ->
    "104";
color_code({bg, bright_magenta}) ->
    "105";
color_code({bg, bright_cyan}) ->
    "106";
color_code({bg, bright_white}) ->
    "107";
color_code({fg, Color}) when is_integer(Color) andalso Color < 256 ->
    "38;5;" ++ integer_to_list(Color);
color_code({bg, Color}) when is_integer(Color) andalso Color < 256 ->
